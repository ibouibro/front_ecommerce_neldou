...
<head>
  ...
  <link href="admin/table1/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

  <!-- Custom styles for this template -->
  <link href="admin/table1/css/sb-admin-2.min.css" rel="stylesheet">
 ...
 @yield("body")
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Niang@ibrahima.sn for ACAN</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
  ...
  <!-- Page level plugins -->
  <script src="admin/staff/table/vendor/datatables/jquery.dataTables.min.js"></script>
  <script src="admin/staff/table/vendor/datatables/dataTables.bootstrap4.min.js"></script>
  
  <!-- Page level custom scripts -->
  <script src="admin/staff/table/js/demo/datatables-demo.js"></script>
